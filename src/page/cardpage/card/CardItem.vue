<template>
	...
	<card-z3-s v-else-if="isCardZ3S" :item="item"></card-z3-s>
...
export default {
	...
	computed: {
		isCardH1: function() {
			return (
				this.isCardItemByStyle(ENUM.CARD_STYLE.H1L) ||
				this.isCardItemByStyle(ENUM.CARD_STYLE.H1R)
			)
		},
		isCardH2L: function() {
		...
		isCardH2R: function() {
			return this.isCardItemByStyle(ENUM.CARD_STYLE.H2R)
		},
		isCardV2B: function() {
			return this.isCardItemByStyle(ENUM.CARD_STYLE.V2B)
		},
		isCardV2T: function() {
			return this.isCardItemByStyle(ENUM.CARD_STYLE.V2T)
		},
		isCardV3B: function() {
			return this.isCardItemByStyle(ENUM.CARD_STYLE.V3B)
		},
		isCardV3T: function() {
			return this.isCardItemByStyle(ENUM.CARD_STYLE.V3T)
		},
		isCardV4B: function() {
			return this.isCardItemByStyle(ENUM.CARD_STYLE.V4B)
		},
		isCardV4T: function() {
		...
		isCardV5: function() {
			return (
				this.isCardItemByStyle(ENUM.CARD_STYLE.V5B) ||
				this.isCardItemByStyle(ENUM.CARD_STYLE.V5T)
			)
		},
		isCardZ1: function() {
		...
		isCardZ2: function() {
			return this.isCardItemByStyle(ENUM.CARD_STYLE.Z2)
		},
		isCardZ2L: function() {
		...
		isCardZ3S: function() {
			return this.isCardItemByStyle(ENUM.CARD_STYLE.Z3S)
		},
		isCardZ4: function() {
	...
	methods: {
		isCardItemByStyle(itemStyle) {
			...
			// console.log('====================================');
			// console.log('（style，itemStyle）  :', style, itemStyle);
			// console.log('====================================');
			if (style === itemStyle) {
				return true
			}
